...
namespace CasaDonSimon
{
    class Program
    {
        ...
        // escribe el titulo grande de cada parte del menu
        static void TituloGrande(string texto)
        {
            // separar las letras para que el titulo se vea mas grande
            string mayus = texto.ToUpper();
            string grande = "";
            for (int i = 0; i < mayus.Length; i++)
            {
                grande = grande + mayus[i] + " ";
            }

            // hacer una linea de adorno del tamano del titulo
            string linea = "";
            for (int i = 0; i < grande.Length + 6; i++)
            {
                linea = linea + "=";
            }
        ...
        static int LeerEntero(int minimo, int maximo)
        {
            ...
            while (sirve == false)
            {
                ...
                else
                {
                    ...
                    Console.Write("Escribe un número del " + minimo + " al " + maximo + ": ");
        ...
        // pregunta que opcion quiere el cliente
        ...
        static void Confirmado()
        {
            Console.WriteLine();
            Console.ForegroundColor = ConsoleColor.Green;
            Console.WriteLine(">> ¡Perfecto! Se agregó a tu ticket.");
        ...
        static void PantallaBienvenida()
        {
            ...
            Console.ForegroundColor = ConsoleColor.Red;
            Console.WriteLine("Martes a domingo   7:30 a.m. - 2:00 p.m.");
            ...
            Console.ForegroundColor = ConsoleColor.DarkYellow;
            Console.WriteLine("Presiona ENTER para ver nuestro menú...");
            Console.ForegroundColor = ConsoleColor.White;
            Console.ReadLine();
        }

        // muestra el menu principal con las categorias
        static void MenuPrincipal()
        {
            ...
            while (opcion != 11)
            {
                ...
                Console.ForegroundColor = ConsoleColor.Green;
                Console.WriteLine("La Casa de Don Simón");
                Console.ForegroundColor = ConsoleColor.White;
                Console.WriteLine("Tradición y ambiente familiar");
                Console.ForegroundColor = ConsoleColor.Red;
                Console.WriteLine("Martes a domingo  7:30 a.m. - 2:00 p.m.");
                ...
                Console.WriteLine("10. Especialidades Don Simón");
                Console.ForegroundColor = ConsoleColor.Red;
                Console.WriteLine("11. Terminar y ver mi ticket");
                Console.ForegroundColor = ConsoleColor.White;
                Console.WriteLine();

                Console.ForegroundColor = ConsoleColor.White;
                Console.WriteLine("Escribe el número de la categoría para elegir tu platillo");
                Console.ForegroundColor = ConsoleColor.White;
        ...
        // muestra las entradas y agrega la que elija el cliente
        static void MenuEntradas()
        {
            ...
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("   Panela asada (200gr), bañada con salsa verde, con un toque de cilantro y acompañada con frijol de la olla.");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();
            ...
            Console.WriteLine("   $90");
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("   Acompañadas con salsa pico de gallo.");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();
            ...
            Console.WriteLine("──────────────────────────────────────────────");
            Console.ForegroundColor = ConsoleColor.Red;
            Console.WriteLine("¿Qué desea ordenar?   (15 = Regresar al menú principal)");
            Console.ForegroundColor = ConsoleColor.White;
        ...
        // muestra los chilaquiles y pregunta por los extras
        static void MenuChilaquiles()
        {
            ...
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("   Crujientes totopos bañados en salsa roja o verde, con crema, queso y cebolla.");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();
            ...
            Console.WriteLine("   $150");
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("   Gratinados o bañados en salsa poblana, con crema, queso y cebolla.");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();

            Console.ForegroundColor = ConsoleColor.Red;
            Console.WriteLine("- - - Puedes agregarle un extra - - -");
            Console.ForegroundColor = ConsoleColor.Green;
            Console.WriteLine("Con huevo  +$25        Con pollo  +$35");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();
            ...
            Console.WriteLine("──────────────────────────────────────────────");
            Console.ForegroundColor = ConsoleColor.Red;
            Console.WriteLine("¿Qué desea ordenar?   (3 = Regresar al menú principal)");
            Console.ForegroundColor = ConsoleColor.White;
            ...
            Console.WriteLine();
            Console.ForegroundColor = ConsoleColor.Red;
            Console.WriteLine("¿Desea agregarle huevo por $25?   (1 = Sí   2 = No)");
            Console.ForegroundColor = ConsoleColor.White;
            ...
            Console.WriteLine();
            Console.ForegroundColor = ConsoleColor.Red;
            Console.WriteLine("¿Desea agregarle pollo por $35?   (1 = Sí   2 = No)");
            Console.ForegroundColor = ConsoleColor.White;
        ...
        static void MenuBurritos()
        {
            ...
            Console.ForegroundColor = ConsoleColor.DarkGray;
            Console.WriteLine("(Los precios son por pieza)");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();
            ...
            Console.WriteLine("   $120");
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("   Burrito de machaca acompañado con salsa pico de gallo y guacamole.");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();
            ...
            Console.WriteLine("   $120");
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("   Burrito de bistec de arrachera acompañado con salsa pico de gallo y guacamole.");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();
            ...
            Console.WriteLine("   $70");
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("   Burrito de papas con chorizo acompañado con salsa pico de gallo y guacamole.");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();

            Console.ForegroundColor = ConsoleColor.Green;
            Console.Write("4. Chicharrón (80gr)");
            Console.ForegroundColor = ConsoleColor.DarkYellow;
            Console.WriteLine("   $95");
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("   Burrito de chicharrón acompañado con salsa pico de gallo y guacamole.");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();
            ...
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("   Burrito de frijol con queso fresco acompañado con salsa pico de gallo y guacamole.");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();
            ...
            Console.WriteLine("──────────────────────────────────────────────");
            Console.ForegroundColor = ConsoleColor.Red;
            Console.WriteLine("¿Qué desea ordenar?   (6 = Regresar al menú principal)");
            Console.ForegroundColor = ConsoleColor.White;
        ...
        // muestra los platillos de huevo
        static void MenuHuevos()
        {
            ...
            Console.WriteLine("   $130");
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("   A elegir: jamón, salchicha, tocino, nopales, mexicanos, papas, chorizo, ejotes, o sopitas. A elegir: chilorio, machaca o chicharrón.");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();
            ...
            Console.WriteLine("   $150");
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("   2 piezas de huevo estrellado montados sobre jamón y tortilla frita, bañados en salsa de la casa.");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();
            ...
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("   2 piezas de huevo estrellado montados sobre chilorio natural y tortilla frita, bañados con salsa ranchera.");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();
            ...
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("   2 piezas de huevo estrellado montados sobre pan de caja dorado con mantequilla, una cama de aguacate, coronado con tiras de tocino, acompañados de ensalada fresca con queso panela.");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();
            ...
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("   2 piezas de huevo estrellado montados sobre jamón y gordita frita, uno bañado en salsa verde y otro en salsa roja.");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();
            ...
            Console.WriteLine("   $185");
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("   2 piezas de huevo bañados con salsa arriera, y puntas de arrachera (80gr) encebolladas.");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();

            Console.ForegroundColor = ConsoleColor.Green;
            Console.Write("7. Omelette Don Simón");
            Console.ForegroundColor = ConsoleColor.DarkYellow;
            Console.WriteLine("   $179");
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("   Relleno de espinaca, champiñón, mantequilla saborizada y acompañado de papas fritas en cuadros. ¡Pídelo bañado en tu salsa favorita! (Roja / Verde / Ranchera).");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();
            ...
            Console.WriteLine("   $179");
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("   Relleno de mezcla de 3 quesos, jamón y acompañado de papas fritas en cuadros. ¡Pídelo bañado en tu salsa favorita! (Roja / Verde / Ranchera).");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();

            Console.ForegroundColor = ConsoleColor.Green;
            Console.Write("9. Omelette de camarón");
            Console.ForegroundColor = ConsoleColor.DarkYellow;
            Console.WriteLine("   $210");
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("   Relleno de camarón (80gr), con queso gratinado, bañado en salsa con crema de chile morrón rojo y acompañado de papas fritas en cuadros.");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();
            ...
            Console.WriteLine("   $179");
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("   Relleno de rajas poblanas con queso, elote y cebolla, bañado en salsa poblana y acompañado de papas fritas en cuadros.");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();
            ...
            Console.WriteLine("   $185");
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("   Relleno de chilorio (80gr) con queso, bañado en salsa ranchera y acompañado de papas fritas en cuadros.");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();

            Console.ForegroundColor = ConsoleColor.DarkGray;
            Console.WriteLine("Todos los desayunos van acompañados de frijoles refritos.");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();
            ...
            Console.WriteLine("──────────────────────────────────────────────");
            Console.ForegroundColor = ConsoleColor.Red;
            Console.WriteLine("¿Qué desea ordenar?   (12 = Regresar al menú principal)");
            Console.ForegroundColor = ConsoleColor.White;
        ...
        // muestra los desayunos completos
        static void MenuDesayunosCompletos()
        {
            ...
            Console.ForegroundColor = ConsoleColor.Green;
            Console.Write("1. Combinación poblana");
            Console.ForegroundColor = ConsoleColor.DarkYellow;
            Console.WriteLine("   $175");
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("   2 piezas de huevo, rajas poblanas con queso, elote y cebolla, tamal natural, frijol refrito y coronado con aguacate.");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();

            Console.ForegroundColor = ConsoleColor.Green;
            Console.Write("2. Combinación del campo");
            Console.ForegroundColor = ConsoleColor.DarkYellow;
            Console.WriteLine("   $175");
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("   2 piezas de huevo, papas con verdura gratinadas, chilaquiles verdes, frijol refrito y coronado con aguacate.");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();

            Console.ForegroundColor = ConsoleColor.Green;
            Console.Write("3. Combinación mar y tierra");
            Console.ForegroundColor = ConsoleColor.DarkYellow;
            Console.WriteLine("   $210");
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("   2 piezas de huevo, tiras de arrachera (100gr) encebolladas, camarón (80gr) ranchero, dos quesadillas, frijol refrito y coronado con aguacate.");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();

            Console.ForegroundColor = ConsoleColor.Green;
            Console.Write("4. Combinación sinaloense");
            Console.ForegroundColor = ConsoleColor.DarkYellow;
            Console.WriteLine("   $185");
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("   2 piezas de huevo, chilorio (80gr) a la mexicana, dos quesadillas, frijol refrito y coronado con aguacate.");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();

            Console.ForegroundColor = ConsoleColor.Green;
            Console.Write("5. Combinación sonora");
            Console.ForegroundColor = ConsoleColor.DarkYellow;
            Console.WriteLine("   $185");
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("   2 piezas de huevo, machaca (50gr) a la mexicana, chilaquiles rojos, frijol refrito y coronado con aguacate.");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();

            Console.ForegroundColor = ConsoleColor.Green;
            Console.Write("6. Combinación Cosalá");
            Console.ForegroundColor = ConsoleColor.DarkYellow;
            Console.WriteLine("   $175");
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("   2 piezas de huevo, colache con verdura, queso gratinado, tamal frito, frijol refrito y coronado con aguacate.");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();

            Console.ForegroundColor = ConsoleColor.Green;
            Console.Write("7. Combinación mi rancho");
            Console.ForegroundColor = ConsoleColor.DarkYellow;
            Console.WriteLine("   $200");
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("   2 piezas de huevo, tiras de arrachera (100gr) encebolladas, chorizo (80gr) con papa, frijol refrito, dos quesadillas y coronado con aguacate.");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();

            Console.ForegroundColor = ConsoleColor.Green;
            Console.Write("8. Combinación Don Simón");
            Console.ForegroundColor = ConsoleColor.DarkYellow;
            Console.WriteLine("   $185");
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("   Tamal gratinado, chilaquiles poblanos, chicharrones (80gr) a la mexicana, frijol refrito y coronado con aguacate.");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();

            Console.ForegroundColor = ConsoleColor.Green;
            Console.Write("9. Combinación americana");
            Console.ForegroundColor = ConsoleColor.DarkYellow;
            ...
            Console.WriteLine("──────────────────────────────────────────────");
            Console.ForegroundColor = ConsoleColor.Red;
            Console.WriteLine("¿Qué desea ordenar?   (10 = Regresar al menú principal)");
            Console.ForegroundColor = ConsoleColor.White;
        ...
        // muestra los platillos tradicionales
        static void MenuTradicionales()
        {
            ...
            Console.WriteLine("   $150");
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("   De maíz, rellenas de papa (100gr) con carne deshebrada (50gr), coronadas con lechuga romana, tomate, pepino, cebolla curtida, queso, crema y acompañados de consomé de res.");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();
            ...
            Console.WriteLine("   $150");
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("   De carne deshebrada (60gr) con frijol y papas fritas en cuadros, coronadas con lechuga romana, tomate, pepino, cebolla curtida, queso, crema y acompañadas de consomé de res.");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();
            ...
            Console.WriteLine("   $165");
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("   De maíz, rellenas de pechuga de pollo deshebrada (90gr) coronadas con lechuga romana, tomate, pepino, cebolla curtida, aguacate, queso, crema y acompañadas de frijoles refritos.");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();
            ...
            Console.WriteLine("   $170");
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("   De maíz, rellenas de pechuga de pollo deshebrada (90gr), gratinadas, coronadas con aguacate y acompañadas de frijoles refritos.");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();
            ...
            Console.WriteLine("   $170");
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("   Papa (100gr) y carne (100gr) en forma de cuadros, coronado con lechuga romana, tomate, pepino, cebolla curtida, aguacate, queso, crema y acompañado de consomé de res.");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();
            ...
            Console.WriteLine("──────────────────────────────────────────────");
            Console.ForegroundColor = ConsoleColor.Red;
            Console.WriteLine("¿Qué desea ordenar?   (8 = Regresar al menú principal)");
            Console.ForegroundColor = ConsoleColor.White;
        ...
        static void MenuSandwiches()
        {
            ...
            Console.ForegroundColor = ConsoleColor.Green;
            Console.Write("1. Sándwich especial");
            Console.ForegroundColor = ConsoleColor.DarkYellow;
            Console.WriteLine("   $185");
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("   Sándwich de pechuga de pollo (100gr), tocino y jamón, gratinado por encima, acompañado de papas fritas en cuadros y un mix de lechuga. ¡Delicioso!");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();

            Console.ForegroundColor = ConsoleColor.Green;
            Console.Write("2. Club sándwich");
            Console.ForegroundColor = ConsoleColor.DarkYellow;
            Console.WriteLine("   $140");
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("   Sándwich de jamón y queso tipo americano, lechuga, tomate, aguacate, acompañado de papas a la francesa.");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();
        ...
        static void MenuKids()
        {
            ...
            Console.WriteLine("   $90");
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("   Con porción de plátano y mermelada de fresa artesanal.");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();

            Console.ForegroundColor = ConsoleColor.Green;
            Console.Write("3. Combinación kids");
            Console.ForegroundColor = ConsoleColor.DarkYellow;
            Console.WriteLine("   $140");
            Console.ForegroundColor = ConsoleColor.Yellow;
            ...
            Console.ForegroundColor = ConsoleColor.Green;
            Console.Write("4. Deditos \"Pío Pío\" (6 piezas)");
            Console.ForegroundColor = ConsoleColor.DarkYellow;
            Console.WriteLine("   $140");
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("   De pechuga de pollo (120gr), empanizados, acompañados de papas a la francesa (80gr) y de aderezo kétchup.");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();
            ...
            Console.WriteLine("──────────────────────────────────────────────");
            Console.ForegroundColor = ConsoleColor.Red;
            Console.WriteLine("¿Qué desea ordenar?   (5 = Regresar al menú principal)");
            Console.ForegroundColor = ConsoleColor.White;
        ...
        // muestra las bebidas y pregunta el sabor o la preparacion
        static void MenuBebidas()
        {
            ...
            Console.ForegroundColor = ConsoleColor.Green;
            Console.Write("1. Café americano (250ml)");
            Console.ForegroundColor = ConsoleColor.DarkYellow;
            Console.WriteLine("   $60");
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("   Café clásico preparado al momento, intenso y aromático.");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();

            Console.ForegroundColor = ConsoleColor.Green;
            Console.Write("2. Café descafeinado (250ml)");
            Console.ForegroundColor = ConsoleColor.DarkYellow;
            Console.WriteLine("   $60");
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("   Sabor y cuerpo del café con menos cafeína.");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();

            Console.ForegroundColor = ConsoleColor.Green;
            Console.Write("3. Café de olla (350ml)");
            Console.ForegroundColor = ConsoleColor.DarkYellow;
            ...
            Console.ForegroundColor = ConsoleColor.Green;
            Console.Write("4. Café Chai (250ml)");
            Console.ForegroundColor = ConsoleColor.DarkYellow;
            ...
            Console.ForegroundColor = ConsoleColor.Green;
            Console.Write("7. Agua para café (250ml)");
            Console.ForegroundColor = ConsoleColor.DarkYellow;
            Console.WriteLine("   $50");
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("   Preparación ligera de café diluido.");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();

            Console.ForegroundColor = ConsoleColor.Green;
            Console.Write("8. Té (250ml)");
            Console.ForegroundColor = ConsoleColor.DarkYellow;
            Console.WriteLine("   $50");
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("   A elegir: manzanilla, verde o canela.");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();

            Console.ForegroundColor = ConsoleColor.Green;
            Console.Write("9. Té Chai Vainilla (250ml)");
            Console.ForegroundColor = ConsoleColor.DarkYellow;
            Console.WriteLine("   Caliente $65   Rocas $75   Frapé $75");
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("   Infusión especiada con un toque de vainilla.");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();
            ...
            Console.WriteLine("   $75");
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("   Bebida láctea con chocolate, bien fría.");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();
            ...
            Console.WriteLine("   $50");
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("   Vaso de leche fría.");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();
            ...
            Console.WriteLine("   $75");
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("   A elegir: plátano, fresa o frutas de temporada.");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();
            ...
            Console.WriteLine("   $70");
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("   A elegir: verde, betabel o zanahoria.");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();
            ...
            Console.WriteLine("   $55");
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("   Clásica y refrescante.");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();
            ...
            Console.WriteLine("   $60");
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("   Con burbujas y un toque cítrico.");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();

            Console.ForegroundColor = ConsoleColor.Green;
            Console.Write("18. Té helado (400ml)");
            Console.ForegroundColor = ConsoleColor.DarkYellow;
            Console.WriteLine("   $55");
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("   Té frío con notas cítricas.");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();
            ...
            Console.WriteLine("   $60");
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("   A elegir: pepino limón, fresa limón, horchata o jamaica.");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();
            ...
            Console.WriteLine("   $70");
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("   Horchata con un rico toque de fresa.");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();

            Console.ForegroundColor = ConsoleColor.Green;
            Console.Write("21. Horchata café (400ml)");
            Console.ForegroundColor = ConsoleColor.DarkYellow;
            Console.WriteLine("   $70");
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("   Horchata con un toque de café.");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();
            ...
            Console.WriteLine("   $50");
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("   Agua mineral con gas.");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();
            ...
            Console.WriteLine("──────────────────────────────────────────────");
            Console.ForegroundColor = ConsoleColor.Red;
            Console.WriteLine("¿Qué desea ordenar?   (25 = Regresar al menú principal)");
            Console.ForegroundColor = ConsoleColor.White;
            ...
            switch (opcion)
            {
                ...
                case 4:
                    ...
                    Console.WriteLine();
                    Console.ForegroundColor = ConsoleColor.Red;
                    Console.WriteLine("¿Cómo lo quiere?   (1 = Caliente   2 = En las rocas   3 = Frapé)");
                    Console.ForegroundColor = ConsoleColor.White;
                ...
                case 5:
                    ...
                    Console.WriteLine();
                    Console.ForegroundColor = ConsoleColor.Red;
                    Console.WriteLine("¿Qué sabor?   (1 = Vainilla   2 = Avellana   3 = Original)");
                    Console.ForegroundColor = ConsoleColor.White;
                ...
                case 8:
                    ...
                    Console.WriteLine();
                    Console.ForegroundColor = ConsoleColor.Red;
                    Console.WriteLine("¿Qué tipo de té?   (1 = Manzanilla   2 = Verde   3 = Canela)");
                    Console.ForegroundColor = ConsoleColor.White;
                ...
                case 12:
                    ...
                    Console.WriteLine();
                    Console.ForegroundColor = ConsoleColor.Red;
                    Console.WriteLine("¿Qué sabor de licuado?   (1 = Plátano   2 = Fresa   3 = Frutas de temporada)");
                    Console.ForegroundColor = ConsoleColor.White;
                ...
                case 13:
                    ...
                    Console.WriteLine();
                    Console.ForegroundColor = ConsoleColor.Red;
                    Console.WriteLine("¿Qué tipo de jugo?   (1 = Verde   2 = Betabel   3 = Zanahoria)");
                    Console.ForegroundColor = ConsoleColor.White;
                ...
                case 19:
                    ...
                    Console.WriteLine();
                    Console.ForegroundColor = ConsoleColor.Red;
                    Console.WriteLine("¿Qué sabor de agua fresca?");
                    Console.WriteLine("(1 = Pepino limón   2 = Fresa limón   3 = Horchata   4 = Jamaica)");
                    Console.ForegroundColor = ConsoleColor.White;
        ...
        // muestra las secciones de especialidades
        static void MenuEspecialidades()
        {
            ...
            Console.ForegroundColor = ConsoleColor.Red;
            Console.WriteLine("¿Qué sección desea ver?");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();
            Console.ForegroundColor = ConsoleColor.Green;
            Console.WriteLine("1. Especialidades (toda la semana)");
            Console.WriteLine("2. Exclusivos de fin de semana");
            Console.WriteLine("3. ¿Tienes un evento próximo?");
            Console.ForegroundColor = ConsoleColor.Red;
        ...
        // muestra las especialidades de toda la semana
        static void MenuEspecialidadesNormales()
        {
            ...
            Console.WriteLine("   $200");
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("   Camarones (150gr) rancheros, acompañados de frijol refrito y dos quesadillas.");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();
            ...
            Console.WriteLine("   $200");
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("   Marlin (150gr) a la mexicana, acompañado de frijol refrito y dos quesadillas.");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();
            ...
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("   Medallones de lengua de res (150gr) en salsa ranchera, verde, roja o poblana, acompañada de frijol refrito y dos quesadillas. También disponible en caldo (sin frijol ni quesadillas).");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();
            ...
            Console.WriteLine("   $240");
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("   Bistec de arrachera (200gr), acompañado de frijol refrito y dos quesadillas.");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();

            Console.ForegroundColor = ConsoleColor.Green;
            Console.Write("5. Hígado encebollado / ranchero");
            Console.ForegroundColor = ConsoleColor.DarkYellow;
            Console.WriteLine("   $160");
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("   Hígado (200gr), acompañado de frijol refrito y dos quesadillas.");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();
            ...
            Console.WriteLine("──────────────────────────────────────────────");
            Console.ForegroundColor = ConsoleColor.Red;
            Console.WriteLine("¿Qué desea ordenar?   (6 = Regresar)");
            Console.ForegroundColor = ConsoleColor.White;
        ...
        // muestra los platillos de fin de semana
        static void MenuFinDeSemana()
        {
            ...
            Console.ForegroundColor = ConsoleColor.DarkGray;
            Console.WriteLine("(Exclusivos de sábado y domingo)");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();
            ...
            Console.WriteLine("   $175");
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("   Menudo tradicional preparado con la receta de la casa.");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();
            ...
            Console.WriteLine("   $185");
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("   Menudo guisado al estilo Don Simón.");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();
            ...
            Console.WriteLine("──────────────────────────────────────────────");
            Console.ForegroundColor = ConsoleColor.Red;
            Console.WriteLine("¿Qué desea ordenar?   (3 = Regresar)");
            Console.ForegroundColor = ConsoleColor.White;
        ...
        // muestra la informacion para eventos
        static void MostrarInfoEvento()
        {
            ...
            Console.ForegroundColor = ConsoleColor.Red;
            Console.WriteLine("¿Tienes algún evento próximo?");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine("La Casa de Don Simón ofrece servicio");
            ...
            Console.WriteLine();
            Console.ForegroundColor = ConsoleColor.Green;
            Console.WriteLine("Tel:  667 852 97 96");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();
            ...
            Console.ForegroundColor = ConsoleColor.DarkGray;
            Console.WriteLine("Abierto al público de martes a domingo");
            Console.WriteLine("7:30 a.m. a 2:00 p.m.   (descansamos los lunes)");
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine();
        ...
        // muestra el ticket con todo lo que se pidio y el total
        static void ImprimirTicket()
        {
            ...
            {
                Console.ForegroundColor = ConsoleColor.Red;
                Console.WriteLine("No se agregó ningún platillo a la orden.");
                Console.ForegroundColor = ConsoleColor.White;
                Console.WriteLine();
            }
            else
            {
                ...
                // mostrar el total
                Console.ForegroundColor = ConsoleColor.DarkYellow;
                Console.WriteLine("TOTAL A PAGAR:   $" + totalCuenta);
                Console.ForegroundColor = ConsoleColor.White;
                Console.WriteLine();
            }
        }
